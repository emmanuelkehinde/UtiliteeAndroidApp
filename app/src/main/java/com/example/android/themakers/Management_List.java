...
public class Management_List extends AppCompatActivity {
    ...
    String[] name={"Senate Building", "Secretariat"
            ...
            ,"DWMS OAU", "University Zoo","Health Centre"};
    ...
    String[] location={"Faculty of Technology Building", "White House Building"
            ...
            ,"Computer Science and Engineering", "Electronics and Electrical Engineering"
            ,"Computer Science and Engineering", "Electronics and Electrical Engineering", "Electronics and Electrical Engineering"};
    String[] description={"Offer courses in Computer Engineering, Computer Science with Mathematics" +
            ...
            ,"Computer Science and Engineering", "Electronics and Electrical Engineering", "Electronics and Electrical Engineering"};
    String[] capacity={"","","","","","","","",""};
    double[] latitude={7.518117,7.519750,20,20,20,20,20,20,20};
    double[] longitude={4.528312,4.520833,20,20,20,20,20,20,20};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_management__list);


        getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Management");

        lv= (ListView)findViewById(R.id.management_list);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(Management_List.this,General_location_display.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.action_game){
            AlertDialog.Builder builder=new AlertDialog.Builder(Management_List.this);
            builder.setCancelable(false).setMessage("Do you want to proceed to the game?")
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(Management_List.this, "Game is Opened", Toast.LENGTH_SHORT).show();
                        }
        ...
        if (id==R.id.action_search){
            AlertDialog.Builder builder=new AlertDialog.Builder(Management_List.this).setCancelable(true);
            ...
            searchButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    alertDialog.dismiss();
                    Toast.makeText(Management_List.this, searchWord, Toast.LENGTH_SHORT).show();
                }
            });
